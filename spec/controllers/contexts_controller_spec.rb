...
RSpec.describe ContextsController, type: :controller do
  ...
  describe "GET #new" do
    it "assigns a new context as @context" do
      ...
      expect(assigns(:context)).to be_a_new(Context)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created context as @context" do
        post :create, {:context => valid_attributes}, valid_session
        expect(assigns(:context)).to be_a(Context)
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved context as @context" do
        post :create, {:context => invalid_attributes}, valid_session
        expect(assigns(:context)).to be_a_new(Context)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested context" do
        context = Context.create! valid_attributes
        put :update, {:id => context.to_param, :context => new_attributes}, valid_session
        context.reload
    ...
    context "with invalid params" do
      it "assigns the context as @context" do
        context = Context.create! valid_attributes
        put :update, {:id => context.to_param, :context => invalid_attributes}, valid_session
        expect(assigns(:context)).to eq(context)
      end
